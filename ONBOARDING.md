...
1. **Standalone repo.** Project lives at `~/Workspace/<slug>/` as its own git repo. (Not nested in ai-workspace.) Symlinked from `~/Workspace/ai-workspace/projects/active/<slug>/` for vault navigation.
...
- Verify symlink at `~/Workspace/ai-workspace/projects/active/<slug>`
