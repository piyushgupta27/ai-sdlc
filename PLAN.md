...
| Execute trip-research MIGRATION.md | `~/Workspace/trip-research/` exists as standalone repo + symlink in ai-workspace; git-crypt key at `~/Workspace/.trip-research-gitcrypt-key` | Tier 0 — explicit user "go" |
